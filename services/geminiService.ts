...
const getMockAdminContent = (prompt: string) => {
    return `
    <h1>Dokumen Administrasi Guru (Mode Simulasi)</h1>
    <hr style="border: 2px solid black; margin: 20px 0;">
    
    <h2>Modul Ajar / Rencana Pelaksanaan Pembelajaran</h2>
    <table style="width:100%; border-collapse:collapse; border:1px solid black; margin-bottom: 20px;">
        <tr>
            <th style="background-color:#f0f0f0; border:1px solid black; padding:8px;">Informasi Umum</th>
...
const getMockPesantrenContent = (prompt: string) => {
    return `
    <div dir="rtl" style="font-family: 'Traditional Arabic', serif; font-size: 18px;">
...
export const generateTextContentStream = async (
    ...
    try {
        ...
        else if (prompt.toLowerCase().includes("soal")) content = getMockQuestionContent(prompt);
